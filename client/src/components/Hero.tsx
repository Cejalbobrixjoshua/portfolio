        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-1/2 mb-12 lg:mb-0 fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                variant="outline"
                className="border-2 border-transparent bg-gradient-to-r from-green-600 to-green-400 bg-clip-border text-green-400 hover:accent-gradient hover:text-[var(--portfolio-primary)] font-medium px-8 py-3 rounded-lg transition-all duration-300"
                style={{
          ...
          <div className="lg:w-1/2 flex justify-center slide-in">
            <div className="relative">
              <div className="w-80 h-80 rounded-full border-4 border-transparent overflow-hidden shadow-2xl" style={{
                background: 'linear-gradient(var(--portfolio-primary), var(--portfolio-primary)) padding-box, linear-gradient(135deg, hsl(142, 76%, 36%) 0%, hsl(142, 60%, 55%) 100%) border-box'
              }}>
                <img
                  src={profileImage}
              ...
              <div className="absolute -top-4 -right-4 w-20 h-20 accent-gradient rounded-full opacity-20"></div>
              <div className="absolute -bottom-4 -left-4 w-16 h-16 accent-gradient rounded-full opacity-30"></div>
            </div>
          </div>
        </div>
      </div>
